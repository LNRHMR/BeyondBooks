...
<head>
  ...
  <title>BeyondBooks │ Your Upload</title>
</head>
      ...
      <div style="max-width:70%;" class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              <a class="nav-link mx-lg-2 active" aria-current="page" href="your-uploads.php">Your Uploads</a>
            </li>
            <li>
...
<div class="container">
  ...
  <h3>Your Uploads</h3>
    ...
    $stmt = $conn->prepare("SELECT * FROM approved WHERE studentnum =? ORDER BY date DESC");
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo "<p class='card-text' style='font-size:11px;'>{$date}</p>";
