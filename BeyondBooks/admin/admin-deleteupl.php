      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item">
              <a class="nav-link mx-lg-2 active" aria-current="page" href="admin-deleteupl.php">Active Files</a>
            </li>
            <li class="nav-item">
    ...
    <tbody>
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>
          ...
          <td><a href='file-prev.php?url=$fileurl' target='iframe'>View File</a></td>
          <td><button class='btn btn-danger' onclick='deleteFile(\"$row[date]\", \"$row[studentnum]\", \"$row[lastname]\", \"$row[email]\", \"$row[filename]\", \"$row[folderlocation]\")'>Delete</button></td>
        </tr>";
      }
...
<!--Script to connect the delete button to the file-delete.php file-->
...
function deleteFile(date, studentnum, lastname, email, filename, folderlocation) {
  ...
  setTimeout(function() {
    location.href = '/BeyondBooks/admin/admin-deleteupl.php?' + new Date().getTime();
